...
class Vertrag extends Component {
                ...
                http.get(`/vertrag/${localStorage.getItem('user')}/id=${this.props.match.params.vertragnumer}`).then((res) => {
                    ...
                    if (res.data.status !== "fail") {
                        ...
                        if (res.data.inhaltabkommen.length > 0) {
                            this.setState({ contractTitle: res.data.abkommen[0].titel })
    ...
    render () {
        ...
        return (
            ...
            <Row>
                <div className="contract-general editor-main">
                    <br />
                    <Row>
                    ...
                    <div>
                        <Row className="center-object"><Col sm={4}>
                    ...
                    <div>
                        ...
                        <Row>
                            <Col sm={2}><button className="default" onClick={() => {this.pointSecondParty()}}>Point Second Party</button></Col>
                            <Col sm={2}>
                    ...
                    <Modal show={this.state.showingPDF} closeBox={() => {this.setState({ showingPDF: false })}}>
                        ...
                        <Document>
                            ...
                            <View style={styles.section}>
                                <Text style={styles.title} ><div className="website-title-text">{this.state.contractTitle}</div></Text>
                                <Text>
                                    <div className="website-title-text">The {this.state.contractTitle} is signed by {this.state.mainPartyuppercase} hereinafter as FIRST PARTY, 
                                    the address is {this.state.einOrt}, Official ID is {this.state.einAnderer}, and {this.state.zweitePartyuppercase} hereinafter 
                                    as SECOND PARTY, the address is {this.state.zweiOrt}, Official ID is {this.state.zweiAnderer}</div>
                                </Text>
                            </View>
                            </Page>
                        </Document>
                ...
                <Row>
                    ...
                    <button className="default" onClick={() => {this.erstellen()}}>Create</button>}
                    {(this.state.contractModifyMode === "erste vertrag" || this.state.contractModifyMode === "zweite vertrag") &&
                    <button className="update" onClick={() => {this.negotiate()}}>Update</button>}
                    {this.state.contractModifyMode === "zweite vertrag" &&
                    <button className="default" onClick={() => {this.ratification()}}>Sign</button>}
                    {(this.state.contractModifyMode === "erste vertrag" || this.state.contractModifyMode === "zweite vertrag") &&
                    <button className="delete" onClick={() => {this.löschen()}}>Delete</button>}
                    {this.state.contractModifyMode === "zweite vertrag" && //"ratified"
                    <button className="default" onClick={() => {this.setState({ showingPDF: true })}}>PDF</button>}
                    </Col>
                </Row>
            </Row>
            </Container>
